...
// Rutas absolutas para inclusión segura
...
if ($_SESSION['login_attempts'] >= $max_attempts && 
    ...
    $remaining_time = ceil(($lockout_time - (time() - $_SESSION['first_failed_attempt'])) / 60);
    $error = "Demasiados intentos fallidos. Por favor, espere $remaining_time minutos e intente nuevamente.";
    ...
    if (empty($_POST['csrf_token']) || !hash_equals($_SESSION['csrf_token'], $_POST['csrf_token'])) {
        ...
        if (empty($email) || empty($password)) {
            ...
            try {
                // Introducir retraso basado en el número de intentos
                $delay = min(5, $_SESSION['login_attempts']);
                sleep($delay);
                ...
                if ($stmt->rowCount() === 1) {
                    ...
                    if (password_verify($password, $user['password'])) {
                        ...
                        // Registrar primer intento fallido
                ...
                log_error("Error en login: " . $e->getMessage(), $logFile);
                ...
                log_error("Error general: " . $e->getMessage(), $logFile);
                $error = 'Error interno del servidor. Por favor, inténtelo de nuevo más tarde.';
            }
        }
    }
